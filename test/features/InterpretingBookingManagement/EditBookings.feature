...
Feature: Edit existing booking
 ...
 #  And I switch to the job allocation window
  ...
  | Allocated            | short notice      | LLAdmin@looped.in  | +`QmHl3w7OQls9g,Qc;7    | Management     |  33124     |  Automation Tester  |  ARABIC     | Zero min ongoing | fortnight after | 09:30 | 4 hours  | hh@bb.com.au        | Unallocated | Female            | consulting | 2314234          | 1234      |  firstname     |  New Zealand    | LL Reporter | 0399999999          |  Phone            | 0399999997                |
  | Allocated            | long notice       | LLAdmin@looped.in  | +`QmHl3w7OQls9g,Qc;7    | Management     |  33124     |  Automation Tester  |  ARABIC     | Zero min ongoing | fortnight after | 09:30 | 4 hours  | hh@bb.com.au        | Unallocated | Male              | consulting | 23r223423        | 45667     |  firstname     |  New Zealand    | LL Reporter | 0399999999          |  Phone            | 0399999999                |
  ...
  |  Auto Notification   | Allocated           | short notice      | LLAdmin@looped.in  | +`QmHl3w7OQls9g,Qc;7   | Management     |  33124     |  Automation Tester  |  AUSLAN  | Zero min ongoing | fortnight after | 09:30 | 4 hours  | hh@bb.com.au | Unallocated | Allocated             | 0399999997                |
...
@EditAllocatedJobRequest @TriggerEmailFields @Video1
  ...
  # And I switch to the job allocation window
   ...
   | short notice      | LLAdmin@looped.in  | +`QmHl3w7OQls9g,Qc;7    | Management     |  33124     |  Auto Tester        |  AFRIKAANS  | Zero min ongoing     | fortnight after | 09:30 | 8 hours    | hh@bb.com.au | Unallocated | Allocated             | Non-Accredited |  Female           | Home Visit           | 11:30     |  have fun     |  New Zealand     | Interpreter A   | 1 St Kilda Rd, St Kilda VIC, Australia |  0399999997               |
