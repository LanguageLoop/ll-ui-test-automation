...
#  no longer exists - but need to confirm with Selva
...
#       | zenq@cso10.com | Test1        |
    ...
    #Scenario 2 - AS CSO User - Verify the Max records displayed as 500   //no longer exists - but need to confirm with Selva
  ...
  Scenario Outline: CSO user can perform search by Contractor using the Search field
   ...
   And I add Before Date filter "<filter comparator 1>" "<filter comparator index 1>"
    ...
    Examples:
      | username cso   | password cso | contractor | Interpreter Name | Interpreter Name column number | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        | Majid      | Majid BRAHMAN    | 6                              | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    | 
  ...
  Scenario Outline: CSO user can perform search by Language using the Search field
    ...
    Examples:
      | username cso   | password cso | language | Language column number | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        | CROATIAN | 5                      | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    | 
  ...
  Scenario Outline: CSO user can perform search by Contact ID using the Search field
   ...
   And I enter the search value "<contact ID>" in the search field
    ...
    Examples:
      | username cso   | password cso | contact ID   | ODTI SERVICE CHARGE ID | ODTI SERVICE CHARGE ID column number | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        | 197934812168 | 100000002470           | 1                                    | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    | 
  ...
  Scenario Outline: CSO user sees No odti billings to show message search is performed using invalid data
   ...
   And I enter the search value "<invalid value>" in the search field
    ...
    Examples:
      | username cso   | password cso | invalid value     | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        | AutoInvalidSearch | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    |
  ...
  Scenario Outline: User should be able to view different pages using pagination when they are more number of records
    ...
    And I should be navigated to page "<previous page number>"
      ...
      Examples:
      | username cso   | password cso | page number | next page number  | previous page number | filter comparator 1 | filter comparator index 1 |
      | zenq@cso10.com | Test1        | 3           | 4                 | 3                    | Before              | 1                         |
  ...
  Scenario Outline: CSO user should be able to click jobs under ODTI SERVICE CHARGE ID column
    ...
    Examples:
      | username cso   | password cso | job detail page url        | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        | OnDemandTI/JobDetails.aspx | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    |
  ...
  Scenario Outline: CSO user should be able to click Campus Name under Campus Name column
    ...
    Examples:
      | username cso   | password cso |  Campus detail page url                | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        |  ManagementModules/CampusDetails.aspx  | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    |
  ...
  Scenario Outline: CSO user should be able to click Interpreter Name under Interpreter Name column
    ...
    Examples:
      | username cso   | password cso |  Interpreter detail page url                      | filter comparator 1 | filter comparator index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 |
      | zenq@cso10.com | Test1        |  ManagementModules/PreviewContractorProfile.aspx  | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    |
