 ...
 #Scenario 1 - CBO user has multiple campuses - Select any campus from the dropdown and select the desired Start Date and End date filters
  ...
  And I click Advanced search link in Admin
   ...
   #  And I add filter RecordStatus "<filter option 4>" "<filter option index 4>", "<filter comparator 4>" "<filter comparator index 4>", "<filter value 4>" "<filter value index 4>"
    ...
    Examples:
      ...
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | After               | 1                         | 01-01-2023     | 1                    | Job Date        |  3                    | Before              | 3                         | 19-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 29449          | 3                    | RecordStatus    | 4                     | Is                 | 4                         | Export         | 1                    | zenq@cbo11.com | Test1        | 29449 Contoso Pty LTD Lysterfield Dr, Roxburgh Park VIC 3064, Australia | 02-01-2023 | 18-01-2023 |
  ...
  Scenario Outline: CBO user has multiple campuses Do Not Select any campus and add desired Start Date and End date filters
   ...
   Examples:
    ...
    | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7  | After               | 1                         | 15-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 19-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 48994          | 3                    | Campus PIN      | 5                     | Is                  | 5                         | 29449          | 4                    | Campus PIN      | 6                     | Is                  | 6                         | 30340          | 5                    | zenq@cbo11.com | Test1        | 16-01-2023 | 18-01-2023 | RecordStatus    | 6                     | Is                  | 6                         | Export         | 1                    |
...
#Examples:
  ...
  Scenario Outline: CBO user has only one campus Select the campus and add desired Start Date and End date filters
   ...
   And I add filter "<filter comparator 1>" "<filter comparator index 1>", "<filter value 1>" "<filter value index 1>"
    ...
    Examples:
      ...
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | After               | 1                         | 01-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 19-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 29449          | 3                    | zenq@cbo10.com | Test1        | 29449 Contoso Pty LTD Lysterfield Dr, Roxburgh Park VIC 3064, Australia | 02-01-2023 | 18-01-2023 | RecordStatus    | 4                     | Is                  | 4                         | Export         | 1                    |
  ...
  Scenario Outline: CBO user has only one campus Do not select any campus and add desired Start Date and End date filters
   ...
   And The RecordStatus Is Export
    ...
    Examples:
      ...
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | After               | 1                         | 01-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 19-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 29449          | 3                    | zenq@cbo10.com | Test1        | 02-01-2023 | 18-01-2023 | RecordStatus    | 4                     | Is                  | 4                         | Export         | 1                    |
  ...
  Scenario Outline: CBO ODTI job results contain only exported jobs
   ...
   # And I add filter RecordStatus "<filter option 4>" "<filter option index 4>", "<filter comparator 4>" "<filter comparator index 4>", "<filter value 4>" "<filter value index 4>"
    ...
    Examples:
     | username          | password             | filter comparator 1 | filter comparator index 1 | filter value 1 | filter value index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 | filter option 3 | filter option index 3 | filter comparator 3 | filter comparator index 3 | filter value 3 | filter value index 3 | username cbo   | password cbo | campus id                                                               | start date | end date   | filter option 4 | filter option index 4 | filter comparator 4 | filter comparator index 4 | filter value 4 | filter value index 4 |
     | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | After               | 1                         | 16-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 19-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 29449          | 3                    | zenq@cbo11.com | Test1        | 29449 Contoso Pty LTD Lysterfield Dr, Roxburgh Park VIC 3064, Australia | 17-01-2023 | 18-01-2023 | RecordStatus    | 4                     | Is                  | 4                         | Export         | 1                    |
  ...
  Scenario Outline: CBO No odti billings to show... message is displayed when no records available
    ...
    Examples:
     | username          | password             | filter comparator 1 | filter comparator index 1 | filter value 1 | filter value index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 | filter option 3 | filter option index 3 | filter comparator 3 | filter comparator index 3 | filter value 3 | filter value index 3 | username cbo   | password cbo | campus id                                                               | start date | end date   | filter option 4 | filter option index 4 | filter comparator 4 | filter comparator index 4 | filter value 4 | filter value index 4 |
     | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | After               | 1                         | 14-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 16-01-2023     | 2                    | Campus PIN      | 4                     | Is                  | 4                         | 29449          | 3                    | zenq@cbo11.com | Test1        | 29449 Contoso Pty LTD Lysterfield Dr, Roxburgh Park VIC 3064, Australia | 15-01-2023 | 15-01-2023 | RecordStatus    | 4                     |  Is                 |  4                        | Export         | 1                    |
  ...
  Scenario Outline: CBO user can see CLIENT CHARGE SUBTOTAL when the CBO user on admin side has the checkbox enabled
    ...
    Examples:
      ...
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | zenq@cbo11.com | Test1        | CLIENT CHARGE SUBTOTAL |
