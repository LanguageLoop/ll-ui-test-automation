 ...
 #LL-627 Scenario 1 - Finance user sees ODTI menu item
  ...
  Scenario Outline: CS / Finance user views ODTI Jobs search section
    ...
    Examples:
      ...
      | testauto@finance1.com | Test1    | ServiceChargeID,OperatorFlag,Campus PIN,Campus Name,Interpreter ID,Interpreter Name,DID Number,Language,Job Date,Exported (INVP),Exported (PAYP),VITSAHFlag,InterpreterAHFlag,InterpreterDuration (In Sec),Bill To Code,Contract name,ClientChargeTotalExGST,InterpreterPaymentTotalExGST,NESPhone,NESConnectionFee,Custom Fields,FiveMinuteRule,RecordStatus,Budget Code - Dimension List,Client Type - Dimension List,PRP dim - Dimension List,Region - Dimension List,Reporting - Dimension List,Service Type - Dimension List,Shortcode - Dimension List,ShortcodeNew - Dimension List | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    |
  ...
  Scenario Outline: Successfully changing the campus pin
    ...
    Examples:
      ...
      | testauto@finance1.com | Test1    | 30889          | 29449          | Yousef     | Before              | 1                         | RecordStatus    | 2                     |  Is                 |  2                        | Export         | 1                    | ClientChargeTotalExGST | 3                     | Is not              | 3                         | 0.00           | 2                    | [EX1] Test1,[EX2] Test2 | test1,test2            | [EX1] Reference number,test | test1,test2             |
