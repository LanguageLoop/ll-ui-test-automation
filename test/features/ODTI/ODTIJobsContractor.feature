 ...
 #Scenario 1 - As Contractor user - Select the Start and End date filters that has Jobs to be displayed
  ...
  Scenario Outline: Contractor user selects the Start and End date filters that has Jobs to be displayed
    ...
    Examples:
      ...
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | Job Date        | 2                     | After               | 1                         | 15-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 21-01-2023     | 2                    | Interpreter ID    | 4                     | Is                  | 4                         | 1293           | 3                    | luciacheung192@gmail.com | _7yJx,h4v^><>edkkJ6N | 16-01-2023 | 20-01-2023 | RecordStatus    | 4                     |  Is                 |  4                        | Export         | 1                    |
  ...
  Scenario Outline: Contractor user selects the Start and End date filters that has no Jobs to be displayed
    ...
    Examples:
      | username          | password             | filter option 1 | filter option index 1 | filter comparator 1 | filter comparator index 1 | filter value 1 | filter value index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 | filter option 3   | filter option index 3 | filter comparator 3 | filter comparator index 3 | filter value 3 | filter value index 3 | username contractor      | password contractor  | start date | end date   | filter option 4 | filter option index 4 | filter comparator 4 | filter comparator index 4 | filter value 4 | filter value index 4 |
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | Job Date        | 2                     | After               | 1                         | 19-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 21-01-2023     | 2                    | Interpreter ID    | 4                     | Is                  | 4                         | 1293           | 3                    | luciacheung192@gmail.com | _7yJx,h4v^><>edkkJ6N | 20-01-2023 | 20-01-2023 | RecordStatus    | 4                     |  Is                 |  4                        | Export         | 1                    |
  ...
  #  And I add filter RecordStatus "<filter option 4>" "<filter option index 4>", "<filter comparator 4>" "<filter comparator index 4>", "<filter value 4>" "<filter value index 4>"
    ...
    Examples:
      | username          | password              | filter option 1 | filter option index 1 | filter comparator 1 | filter comparator index 1 | filter value 1 | filter value index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 | filter option 3   | filter option index 3 | filter comparator 3 | filter comparator index 3 | filter value 3 | filter value index 3 | username contractor      | password contractor  | start date | end date   | filter option 4 | filter option index 4 | filter comparator 4 | filter comparator index 4 | filter value 4 | filter value index 4 |
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7  | Job Date        | 2                     | After               | 1                         | 22-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 28-01-2023     | 2                    | Interpreter ID    | 4                     | Is                  | 4                         | 1293           | 3                    | luciacheung192@gmail.com | _7yJx,h4v^><>edkkJ6N | 23-01-2023 | 27-01-2023 | RecordStatus    | 4                     |  Is                 |  4                        | Export         | 1                    |
  ...
  Scenario Outline: Contractor user can select the desired Start Date and End date filters and Export to Excel
    ...
    Examples:
      | username          | password             | filter option 1 | filter option index 1 | filter comparator 1 | filter comparator index 1 | filter value 1 | filter value index 1 | filter option 2 | filter option index 2 | filter comparator 2 | filter comparator index 2 | filter value 2 | filter value index 2 | filter option 3   | filter option index 3 | filter comparator 3 | filter comparator index 3 | filter value 3 | filter value index 3 | username contractor      | password contractor   | start date | end date   | filter option 4 | filter option index 4 | filter comparator 4 | filter comparator index 4 | filter value 4 | filter value index 4 |
      | LLAdmin@looped.in | +`QmHl3w7OQls9g,Qc;7 | Job Date        | 2                     | After               | 1                         | 08-01-2023     | 1                    | Job Date        | 3                     | Before              | 3                         | 14-01-2023     | 2                    | Interpreter ID    | 4                     | Is                  | 4                         | 1293           | 3                    | luciacheung192@gmail.com | _7yJx,h4v^><>edkkJ6N  | 09-01-2023 | 13-01-2023 | RecordStatus    | 4                     |  Is                 |  4                        | Export         | 1                    |
